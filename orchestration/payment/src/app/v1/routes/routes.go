...
import (
	...
	health "github.com/sofyan48/payment/src/app/v1/api/health/controller"
	order "github.com/sofyan48/payment/src/app/v1/api/order/controller"
	payment "github.com/sofyan48/payment/src/app/v1/api/payment/controller"
	user "github.com/sofyan48/payment/src/app/v1/api/user/controller"
	"github.com/sofyan48/payment/src/middleware"
)
