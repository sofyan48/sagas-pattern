...
type Payment struct {
	...
	IDPaymentStatus   int64      `gorm:"column:id_payment_status;not null;type:varchar(100)" json:"id_payment_status"`
	IDPaymentModel    int64      `gorm:"column:id_payment_model;not null;type:varchar(100)" json:"id_payment_model"`
